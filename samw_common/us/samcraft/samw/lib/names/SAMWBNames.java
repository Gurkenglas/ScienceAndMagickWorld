package us.samcraft.samw.lib.names;
...
public class SAMWBNames {
	...
	public static final String oreSilicon ="Silicon Ore"; 
	public static final String oreOpalBlock = "Opal Block";
	public static final String oreSilver = "Silver Ore"; 
	public static final String oreOrichalcum = "Orichalcum Ore"; 
	public static final String oreStarSteel = "StarSteel Ore"; 
	public static final String oreTitanium ="Titanium Ore"; 
    public static final String oreWonderflonium = "Wonderflonium Ore"; 
	public static final String oreMithril = "Mithril Ore"; 
